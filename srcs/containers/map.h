...
namespace ft {
	...
	public:
		...
		typedef ft::map_iterator_kv<Key, T, value_type*>		iterator;
		typedef ft::map_iterator_kv<Key, T, const value_type*>	const_iterator;
	...
	private:
		red_black_tree<Key, T, Compare, Allocator> _tree;
